...
Indel_Accel_Krnl(consensus, consensus_size, &consensus_size[1], consensus_length, reads, reads_size, &reads_size[1], reads_length, qs, new_ref_idx, global_id * 4 + itr, global_threads, min_whd, min_whd_idx, & con_size_local_base, & consensus_size_ptr, & reads_size_local_base, &reads_size_ptr);
