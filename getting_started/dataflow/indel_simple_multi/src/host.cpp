...
int main(int argc, char** argv ){
    ...
    int num_tests = 0;
    //int* test_indices = parse_schedule("/home/centos/target-dir/21valid.txt", &num_tests);
    int* test_indices = parse_schedule(argv[1], &num_tests);
    ...
    //const char* file_prefix = "/home/centos/target-dir/21/";
